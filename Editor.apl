...
∇E∆Edit fun;Mat;qq;fn;bv;orig;Cms;Pad;Delim;⎕IO;⎕PW                                 
 ...
 qq,←   'edit      =  to modify an existing line,'                                   
 qq,←   'delete    =  to delete a group of lines,'                                   
 qq,←   'move      =  to move lines from one place to another,'
 qq,←   'copy      =  to copy lines from one place to another,'                      
 qq,←   'find      =  to find a character string,'
 qq,←   'replace   =  to search and replace a character string,'                     
 qq,←   'screen    =  to search and list your function a screen at a time,'          
 qq,←   'list      =  to scroll the contents of your function on your screen,'       
 qq,←   'new       =  to erase the entire function,'                                 
 qq,←   'save      =  save function definition,'                                     
 qq,←   'original  =  revert back to original definition,'
 qq,←   'get       =  get a different function to edit'
 qq←','E∆Parse qq                                                                   
